$(document).ready(function(){
  ...
  $("#cplink5").click(function(){
    window.location.href = "../writeups/reglove.html"
  });
  $("#cplink6").click(function(){
    window.location.href = "../writeups/umams.html"
  });
  $("#cplink7").click(function(){
    window.location.href = "../writeups/bipedrobot.html"
  });
  $("#cplink8").click(function(){
    window.location.href = "../writeups/bitsecure.html"
  });
  $("#cplink10").click(function(){
    window.location.href = "../writeups/humanarmrobot.html"
  });
  $("#cplink12").click(function(){
    window.location.href = "../writeups/imitatorobotics.html"
  });
  $("#cplink13").click(function(){
    window.location.href = "../writeups/incubator.html"
  });
  $("#cplink15").click(function(){
    window.location.href = "../writeups/teslacoil.html"
  });
  $("#cplink17").click(function(){
    window.location.href = "../writeups/swarmbots.html"
  });
  $("#cplink19").click(function(){
    window.location.href = "../writeups/solaruav.html"
  });
  $("#cplink21").click(function(){
    window.location.href = "../writeups/handy.html"
  });
  $("#cplink23").click(function(){
    window.location.href = "../writeups/modbots.html"
  });
